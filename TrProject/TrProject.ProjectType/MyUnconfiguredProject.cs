...
namespace TransliterationProject
{
    using System;
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "Transliteration Project", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension, ProjectTemplatesDir = @"..\..\Templates\Projects\MyCustomProject")]
    ...
    internal class MyUnconfiguredProject
    {
        ...
        /// </summary>
        internal const string ProjectExtension = "trproj";
        ...
        /// </remarks>
        internal const string UniqueCapability = "TrProject";

        internal const string Language = "TrProject";
